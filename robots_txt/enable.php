...
// Check for settings.
$settings = Plugin::getAllSettings('robots_txt');

// Flash message
if (Plugin::setAllSettings($settings, 'robots_txt')) {
	Flash::set('success', 'Robots.txt - '.__('Plugin settings initialized') . '.');
}
else {
	Flash::set('error', 'Robots.txt - '.__('Unable to store plugin settings') . '!');
}
