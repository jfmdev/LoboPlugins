...
// Check for settings.
$settings = Plugin::getAllSettings('sitemaps_xml');

// Flash message
if (Plugin::setAllSettings($settings, 'sitemaps_xml')) {
	Flash::set('success', 'Sitemaps XML - '.__('Plugin settings initialized') . '.');
}
else {
	Flash::set('error', 'Sitemaps XML - '.__('Unable to store plugin settings') . '!');
}
